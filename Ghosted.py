...
class ModernEntry(tk.Frame):
    def __init__(self, master, width=None, **kwargs):
        ...
        self.inner_frame = tk.Frame(self, bg="
...
class App:
    def __init__(self, root):
        ...
        self.main_container = tk.Frame(root, bg="
    ...
    def setup_title_bar(self):
        self.title_bar = tk.Frame(self.root, bg="
        self.title_bar.pack(fill="x")
        self.title_bar.bind("<Button-1>", self.start_move)
        self.title_bar.bind("<ButtonRelease-1>", self.stop_move)
        self.title_bar.bind("<B1-Motion>", self.do_move)
        self.title_label = tk.Label(self.title_bar, text="Ghosted", font=("Helvetica", 10), fg="
        self.title_label.pack(side="left", padx=10)
        self.close_button = tk.Label(self.title_bar, text="×", font=("Helvetica", 14), fg="
        self.close_button.pack(side="right")
        self.close_button.bind("<Button-1>", self.on_closing)
        self.close_button.bind("<Enter>", lambda e: self.close_button.config(bg="
        self.close_button.bind("<Leave>", lambda e: self.close_button.config(bg="
    ...
    def setup_icon_and_welcome(self):
        ...
        self.icon_label = tk.Label(self.main_container, image=self.icon_image, bg="
        self.icon_label.pack(pady=3)
        self.welcome_label = tk.Label(self.main_container, text="Welcome, ...", font=("Helvetica", 12), bg="
        self.welcome_label.pack(pady=6)
    def setup_tabs(self):
        self.style = ttk.Style()
        self.style.theme_use('default')
        self.style.configure("TNotebook", background="
        self.style.configure("TNotebook.Tab", background="
        self.style.map("TNotebook.Tab", background=[["selected", "
